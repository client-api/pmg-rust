...
pub struct NodesNetworkCreateNetworkRequest {
    ...
    pub autostart: Option<models::PmgBoolean>,
    ...
    pub bond_mode: Option<models::PmgBondModeEnum>,
    ...
    pub bond_xmit_hash_policy: Option<models::PmgBondXmitHashPolicyEnum>,
    ...
    pub bridge_vlan_aware: Option<models::PmgBoolean>,
    ...
    #[serde(rename = "type")]
    pub r#type: models::PmgTypeTypeEnum,
...
impl NodesNetworkCreateNetworkRequest {
    pub fn new(iface: String, r#type: models::PmgTypeTypeEnum) -> NodesNetworkCreateNetworkRequest {
