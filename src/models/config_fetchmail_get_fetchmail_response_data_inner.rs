...
pub struct ConfigFetchmailGetFetchmailResponseDataInner {
...
impl ConfigFetchmailGetFetchmailResponseDataInner {
    pub fn new(id: String) -> ConfigFetchmailGetFetchmailResponseDataInner {
