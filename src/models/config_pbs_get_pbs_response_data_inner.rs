...
pub struct ConfigPbsGetPbsResponseDataInner {
...
impl ConfigPbsGetPbsResponseDataInner {
    pub fn new(datastore: String, remote: String, server: String) -> ConfigPbsGetPbsResponseDataInner {
